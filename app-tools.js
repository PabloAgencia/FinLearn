...
const F28_BRANCHES = [
  ...
  },
  {
    ...
    mods: [4, 9, 21, 28, 38, 42, 49, 51, 60, 68, 83, 91, 94, 100]
  },
  {
    id: 'psicologia', label: 'Psicología', emoji: '🧠', color: '#c084fc',
    mods: [2, 6, 20, 33, 54, 59, 67, 71, 74, 78, 95, 98, 107]
  },
  {
    id: 'avanzado', label: 'Avanzado', emoji: '🚀', color: '#f87171',
    mods: [5, 8, 10, 12, 13, 15, 17, 18, 19, 22, 23, 24, 27, 35, 40, 43, 44, 45, 46, 47, 50, 52, 56, 63, 64, 65, 69, 72, 73, 76, 77, 79, 80, 81, 82, 89, 90, 93, 97, 102]
  },
  {
